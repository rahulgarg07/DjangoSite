...
class User_info(User):
    ...
    user_pic = models.ImageField(upload_to='', default=None, blank=True, null=True)
...
class Post_info(models.Model):
    ...
    post_disp_img = models.ImageField(upload_to='', default='default_user.jpg', blank=True, null=True)
